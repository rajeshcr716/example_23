...
@NamedNativeQueries({
      ...
      // pagination purpose named native query is used. ( need to check)
...
/*
NATIVE QUERY VS NAMED NATIVE QUERY
Native query refers to actual sql queries (referring to actual database objects).
 ...
 2. Named query is the way you define your query by giving it a name.
...
public class Contact  extends BaseEntity {
 ...
 @Id   //  it is used to mention primary column.
